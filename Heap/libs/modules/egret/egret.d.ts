...
declare namespace egret.sys {
    ...
    class SystemTicker {
         ...
         * @private
         */
        $startTick(callBack: (timeStamp: number) => void, thisObject: any): void;
        /**
         * @private
         */
        $stopTick(callBack: (timeStamp: number) => void, thisObject: any): void;
        /**
         * @private
         */
...
declare namespace egret {
    class CanvasRenderer {
        ...
        renderGraphics2(node: sys.GraphicsNode, buffer: sys.RenderBuffer, matrix: Matrix, forHitTest?: boolean): void;
        /**
         * @private
         */
...
declare namespace egret.web {
    ...
    class WebGLDrawCmdManager {
         ...
         * 压入绘制texture指令
         */
        pushDrawTexture(texture: any, count?: number, filter?: any, textureWidth?: number, textureHeight?: number, smoothing?: boolean): void;
        /**
         * 压入pushMask指令
         */
...
declare namespace egret.web {
    ...
    class WebGLRenderContext {
        ...
        static getInstance(): WebGLRenderContext;
         ...
         * 绘制Mesh
         */
        drawMesh(image: BitmapData, sourceX: number, sourceY: number, sourceWidth: number, sourceHeight: number, destX: number, destY: number, destWidth: number, destHeight: number, imageSourceWidth: number, imageSourceHeight: number, meshUVs: number[], meshVertices: number[], meshIndices: number[], bounds: Rectangle, smoothing: boolean): void;
        /**
         * 绘制材质
         */
